...
- ### Reduction_Data_&_Logs (Folder)
  ...
  - **\*_aor_data.csv**: These files provide the average flux per AOR and other important information for individual AORs such as aorkey, date of obsservation, dither information etc.
...
- ### Experiments (Folder)
  Please ignore this folder. It contains my scrtach works and tests that I did before incorporating various pieces of code into the pipeline.
