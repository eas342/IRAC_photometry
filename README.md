...
- ### Plots Summary
  ...
  - *calStars_ch1.png* : This is a time series for both calibrator stars using ch1 data. The cryogenic mission data and warm mission data are shown on the same plot. It seems that there is a shift between these two missions.
